...
router.get("/search", (req,res)=>{
    ...
    // T.get('geo/search', {query: "West Virginia"}, (err, data, response) => {
...
T.get('search/tweets', { q: 'place:4ec01c9dbc693497', count: 20, result_type: "popular"}, function(err, data, response) {
